...
$tpl->assign( "module_headline", "Aufgabe 5" );

// Text
$tpl->assign( "text", "Bitte nehmen Sie die folgende Änderung in Ihrer Datenbank vor!<p><strong>Ihre Sekretärin Maria 
Schmidt hat letzte Woche Ihren Verlobten Joachim Müller geheiratet und den Namen ihres Mannes angenommen.</strong></p>");
