...
/// Text
$tpl->assign( "text", "Welche der untenstehenden SELECT-Anweisungen liefert als Ergebnis 'Verkäufer'?<br/>Die zugehörige
Tabelle finden Sie im Tipp im Kopf der Seite" );
...
$tpl->assign( "single_choice", "
	<label type='text' class='btn btn-default btn-group btn-group-justified radioButton'>
		...
		<span><code>SELECT Position FROM Personal WHERE PersNR = 3 AND FamStatus = 'ledig';</code></span>
	</label>
	<label type='text' class='btn btn-default btn-group btn-group-justified radioButton'>
		<input type='radio' name='aufgabe' />
		<span><code>SELECT Name FROM Personal WHERE Position = 'Verkäufer';</code></span>
	</label>
	<label type='text' class='btn btn-default btn-group btn-group-justified radioButton'>
		<input class='solution' type='radio' name='aufgabe'	/>
		<span class='solution'><code>SELECT Position FROM Personal WHERE Name = 'Jürgen Schmidt';</code></span>
	</label>
	<label type='text' class='btn btn-default btn-group btn-group-justified radioButton'>
		<input type='radio' name='aufgabe' />
		<span><code>SELECT Position FROM Personal WHERE Gehalt < 5000 ;</code></span>
	</label>
" );
