...
// Text
$tpl->assign( "text", "Aus der ER-Modellierung resultiert ein ER-Diagramm (oder ER-Schema), in dem die dargestellten
Gegenstände und Beziehungen durch Kanten verbunden sind:<br/><br/>
<img class='img-responsive center-block' src='../../images/fis/ERM-Schema.jpg' alt='ERM-Schema'>" );
