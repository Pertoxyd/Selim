...
$tpl->assign( "module_headline", "Aufgabe 8" );

// Text
$tpl->assign( "text", "Es müssen Einsparungen vorgenommen und alle Mitarbeiter, die mehr als 5000 verdienen, entlassen 
werden.<p><strong>Formulieren Sie eine SQL-Anweisung mit der Sie diese Mitarbeiter aus der Datenbank entfernen!</strong></p>");
