...
$tpl->assign( "module_headline", "SELECT" );

// Text
$tpl->assign( "text", "Die SQL-Anweisung <p><code>SELECT Nachname, Vorname FROM Studierende WHERE
Studiengang = 'Lehramt';</code></p><p>bewirkt also folgendes:</p>");
