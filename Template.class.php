...
class Template
{
    ...
    public function __construct($tpl_dir = "", $lang_dir = "") {
        ...
        if ( !empty($tpl_dir) ) {
			...
			$this->templateDir = get_defined_constants()["SELIMFILEBASE"].$this->templateDir;
		}
        ...
        if ( !empty($lang_dir) ) {
			...
			$this->languageDir = get_defined_constants()["SELIMFILEBASE"].$this->languageDir;
		}
    }
    ...
    private function parseFunctions() {
		...
		$this->assign("selimwebbase",get_defined_constants()["SELIMWEBBASE"]);
    }
